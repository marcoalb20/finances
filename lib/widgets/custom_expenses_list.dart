...
class CustomExpensesList extends StatelessWidget {
  const CustomExpensesList({super.key});
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return CustomExpenses(
                      ...
                      mountText: 'S/ ${financeProvider.expenses[index].amount}',
                    );
                  },
...
class CustomExpenses extends StatelessWidget {
          ...
          children: [
            Row(
              children: [
                InkWell(
                  onTap: () {
                    financeProvider.removeExpense(itemId);
                  },
                  child: Container(
